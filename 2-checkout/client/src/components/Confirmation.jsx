...
const Confirmation = ({formOneData, formTwoData, formThreeData}) => {
    ...
    <div className='formContainer'>
      ...
      <div className='formBody'>
        <div className='formLine'>
            <center>Thank you <strong>{formOneData.name}</strong> for shopping at <strong>Charlie's Ugly Portraits!</strong></center>
        </div>
        <div>&nbsp;</div>
        <div className='formLine'>
